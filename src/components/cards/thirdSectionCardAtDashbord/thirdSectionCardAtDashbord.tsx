...
interface IThirdSectionCardAtDashbord {
...
const ThirdSectionCardAtDashbord: React.FC<
  IThirdSectionCardAtDashbord
    > = ({
 backgroundColor,
  title,
  imgCarPath,
          ...
          >
            ...
            <footer className="flex justify-between text-[#72767C] mt-1">
              <div className="flex gap-3 items-center">
                ...
                <img
                  src="./setting at card icon.svg"
                  alt="icon for card"
                  className="h-[13.34px] w-[13.36px]"
                />
                <img
                  src="./icon card section3.svg"
                  alt="icon for card"
...
export default ThirdSectionCardAtDashbord;